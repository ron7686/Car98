...
//		int n = 0;
//		String hql = "UPDATE MemberBean set password =:passowrd,"
//				+ " id=:id, phone=:phone, headPic=:headPic, filename:filename,"
//				+ " where memId= :memId";
//		session.createQuery(hql).setParameter("memId", mb.getMemId())
//								.setParameter("password", mb.getPassword())
//								.setParameter("id", mb.getId())
//								.setParameter("phone", mb.getPhone())
//								.setParameter("headPic", mb.getHeadPic())
