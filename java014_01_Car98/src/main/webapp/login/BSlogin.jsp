...
<body>
     ...
     <nav class="navbar navbar-expand-lg navbar-dark">
      <a class="navbar-brand" href="${pageContext.request.contextPath}/index.jsp"><img src="${pageContext.request.contextPath}/image/car98logo.png" width="60" height="60" alt=""></a>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="BSlogin.jsp">註冊登入 <span class="sr-only">(current)</span></a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <!-- <section class="my-5"> -->
      <div class="container d-flex text-white container-height" >
        <div class="row align-items-center">
          <div class="col-md-6"><img src="${pageContext.request.contextPath}/image/car98logo.png" width="100%" height="200px" alt=""></div>
          <div class="col-md-6">
            <form action="" class="needs-validation" novalidate>
              ...
              <div class="my-3 text-center">
                <a href="${pageContext.request.contextPath}/register/register.jsp" class="text-light">註冊帳號</a>
                <a href="#" class="text-light ml-2">忘記密碼</a>
              </div>
              <div class="my-3 text-center">
                <a href="#" class="text-light"><i class="fab fa-facebook-square fa-2x"></i></a>
                <a href="#" class="text-light"><i class="fab fa-google fa-2x"></i></a>
              </div>
            </form>
          </div>
        </div>
