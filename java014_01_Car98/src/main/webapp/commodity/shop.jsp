...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark ">
		<a class="navbar-brand"
			...
			src="../image/car98logo.png" width="50" height="50" alt=""></a>
		...
		<div class="collapse navbar-collapse justify-content-end"
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item active"><a class="nav-link"
					href="/BSlogin.html">註冊登入 <span class="sr-only">(current)</span></a>
				</li>
			</ul>
		</div>
	</nav>
		...
		<div class="row">
			<div class="col-md-3 col-sm-6">
				<div class="product-grid">
					...
					<div class="product-content">
						<h3 class="title">
							<a href="#"> 360度旋轉車載手機支架</a>
						</h3>
						<div class="price">
							$490
							<!-- <span>$1000</span> -->
						</div>
						<a data-name="360度旋轉車載手機支架" data-price="490" class="add-to-cart"
							href="">+ Add To Cart</a>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6">
				<div class="product-grid">
					...
					<div class="product-content">
						<h3 class="title">
							<a href="#">K1PLUSGPS衛星定位安全警示器</a>
						</h3>
						<div class="price">
							$500
							<!-- <span>$1000</span> -->
						</div>
						<a class="add-to-cart" data-name="K1PLUSGPS衛星定位安全警示器"
							data-price="500" href="">+ Add To Cart</a>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6">
				<div class="product-grid">
					...
					<div class="product-content">
						...
						<a class="add-to-cart" data-name="電動打氣機" data-price="500" href="">+
							Add To Cart</a>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6">
				<div class="product-grid">
					...
					<div class="product-content">
						<h3 class="title">
							<a href="#">MiVue大光圈GPS行車記錄器</a>
						</h3>
						<div class="price">
							$100
							<!-- <span>$1000</span> -->
						</div>
						<a class="add-to-cart" data-name="MiVue大光圈GPS行車記錄器"
							data-price="100" href="">+ Add To Cart</a>
					</div>
				</div>
			</div>
			<!-- </div> -->
			...
			<div class="col-md-3 col-sm-6">
				<div class="product-grid">
					...
					<div class="product-content">
						<h3 class="title">
							<a href="#">GARMIN 車用衛星導航</a>
						</h3>
						<div class="price">
							$150
							<!-- <span>$1000</span> -->
						</div>
						<a class="add-to-cart" data-name="GARMIN車用衛星導航" data-price="150"
							href="">+ Add To Cart</a>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						<a href="#"> <img class="pic-1" src="../image/shp11.jpg" /> <img
							class="pic-2" src="../image/shp12.jpg" />
						</a>
					</div>
					<div class="product-content">
						<h3 class="title">
							<a href="#">SILVERS NEOMAX 避震器</a>
						</h3>
						<div class="price">
							$500
							<!-- <span>$1000</span> -->
						</div>
						<a class="add-to-cart" data-name="SILVERSNEOMAX避震器"
							data-price="500" href="">+ Add To Cart</a>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						<a href="#"> <img class="pic-1" src="../image/shp13.jpg" /> <img
							class="pic-2" src="../image/shp14.jpg" />
						</a>
					</div>
					<div class="product-content">
						<h3 class="title">
							<a href="#">BASEUS 手機支架</a>
						</h3>
						<div class="price">
							$799
							<!-- <span>$1000</span> -->
						</div>
						<a class="add-to-cart" data-name="BASEUS手機支架" data-price="799"
							href="">+ Add To Cart</a>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						<a href="#"> <img class="pic-1" src="../image/shp15.jpg" /> <img
							class="pic-2" src="../image/shp16.jpg" />
						</a>
					</div>
					<div class="product-content">
						<h3 class="title">
							<a href="#">Formula1超級防護頂級棕櫚臘</a>
						</h3>
						<div class="price">
							$699
							<!-- <span>$1000</span> -->
						</div>
						<a class="add-to-cart" data-name="Formula1超級防護頂級棕櫚臘"
							data-price="699" href="">+ Add To Cart</a>
					</div>
				</div>
			</div>
		</div>
