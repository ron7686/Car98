...
<body>
	...
	<div class="container">
		...
		<div class="col-10">
			<ul class="article-information">
				<li class="floor">2樓<br> <a href="#">發表於 2020-09-02
						09:21 PM</a></li>
			...
			<div class="col-12 article-content">
				先看預算，再來就是外型和內裝還有主被動安全配備這些<br> 買車主要還是自己喜歡最重要
			</div>
	...
	<div class="col-2">
		<br> <a href="#"><img class="photo"
			src="../image/Shirahoshi.png"></a>
		<div class="author">白星公主</div>
		<div class="account">shirahoshi123</div>
	</div>
	...
	<div class="col-10">
		<ul class="article-information">
			<li class="floor">3樓<br> <a href="#">發表於 2020-09-02
					10:28 PM</a></li>
		...
		<div class="col-12 article-content">
			依有限的預算選擇自己能負擔的品牌車，<br> 並且考量所選購的車子是否省油，且後續保養費用是否會過於昂貴，<br>
	...
	<div class="container">
		<div class="row">
			<div class="col-12 mt-2">
				<form class="comment">
					<textarea class="" cols="68" rows="5" style="width: 100%"
	...
	<div class="row">
		<div class="col-12 mt-2">
			<form class="comment"
				...
				method="Post">
				<textarea id="comments" name="comments" class="" cols="68" rows="5"
					placeholder="請輸入內容...."></textarea>
				<input type="file" class="form-control-file"
					id="exampleFormControlFile1"> <input class="float-right"
					type="submit" value="送出">
